...
const mapStateToProps = (state: AppState, ownProps: FeaturedQuestsStateProps): FeaturedQuestsStateProps => {
  const quests: QuestDetails[] = [ // Featured quests (id's generated from publishing, but don't leave them published!)
    {id: '0B7K9abSH1xEOeEZSVVMwNHNqaFE', partition: 'expedition-public', title: 'Learning to Adventure', summary: 'Your first adventure.', author: 'Todd Medema', publishedurl: 'quests/learning_to_adventure.xml'},
    {id: '0B7K9abSH1xEOWVpEV1JGWDFtWmc', partition: 'expedition-public', title: 'Learning 2: The Horror', summary: 'Your first adventure continues with Expedition: The Horror.', author: 'Todd Medema', publishedurl: 'quests/learning_to_adventure_2_the_horror.xml', expansionhorror: true },
    {id: '0BzrQOdaJcH9MU3Z4YnE2Qi1oZGs', partition: 'expedition-public', title: 'Oust Albanus', summary: 'Your party encounters a smelly situation.', author: 'Scott Martin', publishedurl: 'quests/oust_albanus.xml'},
    {id: '0B7K9abSH1xEORjdkMWtTY3ZtNGs', partition: 'expedition-public', title: 'Mistress Malaise', summary: 'Mystery, Misfortune, and a Mistress.', author: 'Scott Martin', publishedurl: 'quests/mistress_malaise.xml'},
    {id: '0B7K9abSH1xEOUUR1Z0lncm9NRjQ', partition: 'expedition-public', title: 'Dungeon Crawl', summary: 'How deep can you delve?', author: 'Todd Medema', publishedurl: 'quests/dungeon_crawl.xml'},
  ];
