...
var Tabs = function (_Component) {
  ...
  function Tabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Tabs)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = { selectedIndex: 0 }, _this.handleTabTouchTap = function (value, event, tab) {
      ...
      _this.props.onChangeAttempt(_this.getTabs()[_this.state.selectedIndex].props.value, value, function() {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['contentContainerClassName', 'onChangeAttempt', 'contentContainerStyle', 'initialSelectedIndex', 'inkBarStyle', 'style', 'tabItemContainerStyle', 'tabTemplate']);
...
Tabs.propTypes = {
  ...
  onChangeAttempt: _react.PropTypes.func,
  /**
