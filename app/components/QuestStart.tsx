  ...
  return (
    <Card title="Setup">
      <ol>
        ...
        {singlePlayer && <ul><li><strong>Single Player:</strong> Draft pick each ability (draw three, keep one).</li></ul>}
      ...
      {multiPlayer && <p>
        ...
        {!props.settings.multitouch && <span> During combat, one player will manage the device.</span>}
      </p>}
