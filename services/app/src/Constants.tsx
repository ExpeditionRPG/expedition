...
export const TUTORIAL_QUESTS: Quest[] = [ // Featured quest ids generated from publishing, but don't leave them published!
  new Quest({
    ...
    summary: 'Your first adventure, covering base mechanics.',
    author: 'Todd Medema',
  ...
  new Quest({
    ...
    summary: 'Learn about Persona, Influence abilities, and Horror enemies.',
    author: 'Todd Medema',
  ...
  new Quest({
    ...
    summary: 'Learn about Skills, Tech abilities, and Synth enemies.',
    author: 'Greg Miller',
