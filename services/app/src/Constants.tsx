...
export const FEATURED_QUESTS: QuestDetails[] = [ // Featured quest ids generated from publishing, but don't leave them published!
  ...
  // TODO make actual intro Future quest
  {id: '0B7K9abSH1xEOWVpEV1JGWDFtWmc', partition: 'expedition-public', theme: 'base', official: true, title: 'Learning 3: The Future', summary: 'TODO', author: 'Todd Medema', publishedurl: 'quests/learning_to_adventure_2_the_horror.xml', expansionhorror: true, expansionfuture: true, minplayers: 1, maxplayers: 6, mintimeminutes: 20, maxtimeminutes: 40, genre: 'Drama', contentrating: 'Everyone', language: 'English' },
