    ...
    switch (value) {
      ...
      case 'HOME':
        if (!this.props.inQuest) {
          return dispatch(
            toPrevious({
              matchFn: (c: CardName, n: ParserNode) => c === 'SPLASH_CARD',
              before: false,
            }),
          );
        }
    ...
    return (
      <div className={classes.join(' ')}>
        <div className="title_container">
          {this.props.hasReturn && (
            <IconButton
              id="titlebarReturnButton"
          ...
          <span className="menu">
            ...
            >
              ...
              <MenuItem
                {...this.menuItemDisableProps('SETTINGS')}
                onClick={() => {
                  this.onMenuSelect('SETTINGS');
                }}
              >
                Settings
              </MenuItem>
              {this.props.user && this.props.user.loggedIn && (
                <MenuItem
                  {...this.menuItemDisableProps('ACCOUNT')}
                  id="accountButton"
                  onClick={() => {
                    this.onMenuSelect('ACCOUNT');
                  }}
                >
                  Account
                </MenuItem>
              ...
              <MenuItem
                onClick={() =>
                  openWindow('https://expeditiongame.com/store?utm_source=app')
                }
              >
                Shop
              </MenuItem>
          ...
          <div className="scrollbox">
            <div className="scrollbox_top">
              <svg
                ...
                x="0px"
                y="0px"
                viewBox="0 0 15.5 1.2"
              >
                <path
                  className="st0"
                  d="M6.9,0.8c0.1,0,0.2-0.1,0.2,0c0,0,0,0,0.1-0.1c0,0,0.1,0,0.2,0c-0.1,0-0.1,0-0.3,0C7,0.8,6.7,0.8,6.6,0.9C6.7,0.8,6.8,0.9,6.9,0.8z"
                />
                <path
                  className="st0"
                  d="M7.6,0.8L7.6,0.8C7.6,0.8,7.6,0.8,7.6,0.8C7.4,0.9,7.4,0.9,7.4,0.9L7.6,0.8z"
                />
                <path
                  className="st1"
                  d="M8.4,0.9C8.3,0.9,8.5,0.9,8.4,0.9c0,0,0.2,0.1,0.3,0.1h0.1C8.7,0.9,8.4,0.9,8.2,0.8C8.2,0.8,8.3,0.8,8.4,0.9C8.3,0.9,8.4,0.9,8.4,0.9z"
                />
                <path
                  className="st0"
                  d="M8.6,0.9L8.6,0.9C8.6,0.9,8.4,0.9,8.6,0.9z"
                />
                <path
                  className="st0"
                  d="M8.4,0.8C8.3,0.7,8.5,0.8,8.4,0.8C8.4,0.8,8.5,0.8,8.4,0.8z"
                />
                <path
                  className="st1"
                  d="M9.1,1c0,0-0.1,0-0.2,0C8.8,1,8.7,1,8.7,1s0,0,0.1,0h0.1H9.1C9.1,1,9.1,1,9.1,1z"
                />
                <path
                  className="st1"
                  d="M9.1,1.1C9.1,1.1,9,1,9.1,1.1c0.1,0,0.2,0,0.3,0H9.3c0,0,0.3,0,0.2,0.1c0.2,0-0.1-0.1,0.1-0.1C9.5,1.1,9.3,1,9.1,1.1h0.1c-0.1,0-0.3,0-0.4,0C8.9,1.1,9,1,9.1,1.1z"
                />
                <path
                  className="st1"
                  d="M9.7,1.2c0.1,0,0.3,0,0.4,0c-0.1,0-0.2,0-0.2,0C9.9,1.1,9.7,1.1,9.7,1.2C9.8,1.1,9.7,1.1,9.7,1.2z"
                />
                <path
                  className="st1"
                  d="M10.3,1.2L10.3,1.2L10.3,1.2L10.3,1.2c0-0.1,0,0-0.2,0C10.2,1.2,10.2,1.2,10.3,1.2z"
                />
                <path
                  className="st1"
                  d="M10.3,1c0.1,0,0.1,0,0.2,0c-0.1,0-0.3,0-0.4,0l0,0c0,0-0.1,0-0.2,0C10.1,1,10.3,1.1,10.3,1z"
                />
                <path className="st1" d="M10.1,1h0.1H10.1z" />
                <polygon className="st1" points="10.7,1.2 10.5,1.2 10.5,1.2" />
                <path
                  className="st1"
                  d="M10.4,1.1C10.6,1.1,10.3,1.1,10.4,1.1c0.1,0-0.2,0-0.2,0C10.3,1.1,10.4,1.1,10.4,1.1z"
                />
                <path className="st1" d="M10.8,1.2H11H10.8z" />
                <path
                  className="st1"
                  d="M11.2,1.2L11.2,1.2c0.2,0,0.4,0,0.5,0c0,0,0.1-0.1-0.1-0.1h-0.1c-0.1,0,0,0-0.1,0C11.4,1.2,11.2,1.2,11.2,1.2L11.2,1.2c-0.1,0-0.2-0.1-0.2,0C11,1.2,11.1,1.2,11.2,1.2z"
                />
                <path
                  className="st1"
                  d="M11.2,1.1h-0.1H11.2C11.2,1,11.1,1,11.2,1.1c-0.1,0-0.2-0.1-0.2,0c-0.2,0-0.1,0-0.2,0h-0.1C10.9,1.1,11,1.1,11.2,1.1z"
                />
                <path
                  className="st1"
                  d="M11.7,1.1L11.7,1.1L11.7,1.1c0.3,0,0.5,0.1,0.7,0s0.4,0,0.7-0.1C13.2,1,13,1,13,1c0-0.1,0.1,0,0.2,0c0,0-0.2,0-0.3,0s-0.1,0-0.1,0.1h-0.1c-0.2,0.1-0.3,0-0.5,0.1c-0.1,0,0.1,0,0.1,0h-0.1l0,0C12.1,1.2,11.8,1.2,11.7,1.1C11.7,1.1,11.7,1.1,11.7,1.1h-0.1l-0.2,0.1C11.5,1.1,11.7,1.1,11.7,1.1z"
                />
                <path
                  className="st1"
                  d="M11.5,1c-0.2,0,0,0-0.2,0C11.3,1.1,11.4,1.1,11.5,1C11.5,1.1,11.5,1.1,11.5,1L11.5,1z"
                />
                <path
                  className="st0"
                  d="M12.5,1L12.5,1c0.1,0,0.1,0,0.1,0C12.5,1,12.4,1.1,12.5,1z"
                />
                <path className="st0" d="M12.9,1L12.9,1L12.9,1z" />
                <path
                  className="st1"
                  d="M13.2,0.9c0.1,0,0,0-0.1,0C13.2,0.9,13.2,0.9,13.2,0.9z"
                />
                <path
                  className="st0"
                  d="M13.8,0.9C13.7,0.9,13.7,0.9,13.8,0.9C13.8,0.9,13.9,0.9,13.8,0.9C13.8,0.9,13.9,0.8,13.8,0.9z"
                />
                <path
                  className="st1"
                  d="M14.4,0.8C14.3,0.8,14.3,0.8,14.4,0.8C14.3,0.8,14.3,0.8,14.4,0.8z"
                />
