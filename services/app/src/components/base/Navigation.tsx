...
export default class Navigation extends React.Component<Props, {}> {
  private computeValue() {
    switch (this.props.card.name) {
      ...
      default:
        console.error(
          'Unknown navigation state for card name ' + this.props.card.name,
        );
  ...
  private genIcon(name: string): JSX.Element {
    return (
      <img
        ...
        src={'images/' + formatImg(name, this.props.cardTheme, true) + '.svg'}
      />
    );
  }
    ...
    return (
      ...
      >
        <BottomNavigationAction
          ...
          id="tutorials"
          label="Tutorial"
          value="TUTORIAL_QUESTS"
          icon={this.genIcon('helper')}
        />
        <BottomNavigationAction
          classes={{ label: 'navlabel' }}
          id="offline"
