...
import { handleCombatTimerHold, handleCombatTimerStop } from './Actions';
  ...
  return {
    onTimerStop: (
      ...
      if (multiplayer.connected) {
        ...
        dispatch(
          handleCombatTimerStop({ node, settings, elapsedMillis, seed }),
        );
      }
    },
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(NoTimer);
