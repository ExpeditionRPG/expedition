  ...
  return (
    <Card title="Lobby">
      <div className="remoteplay">
        ...
        <h1 className="sessionCode">
          {props.multiplayer.session && props.multiplayer.session.secret}
        </h1>
        <h2>Content Sets</h2>
        <p>
          These are the content sets that every device has, and thus will be
        ...
        <h2>Quick Tips</h2>
        <p>
          The bottom bar indicates that you are in an online multiplayer
          session:
        </p>
        <table>
          <tbody>
            <tr>
              <td>
                <img
                  ...
                  src="images/adventurer_small.svg"
                />
              </td>
              <td>
        ...
        <p>
          Click the connected adventurers or connection state for more
          information.
        </p>
        <h2>Adventurers</h2>
        ...
        <PlayerCount
          ...
          onChange={(localPlayers: number) =>
            props.onPlayerChange(localPlayers)
          }
        />
        <br />
        ...
        <Button
          ...
          disabled={allPlayers > MAX_ADVENTURERS}
          onClick={() => {
            props.onStart();
          }}
        >
          {allPlayers > MAX_ADVENTURERS
            ? `Player count must be ≤ ${MAX_ADVENTURERS}`
            : 'Start'}
        </Button>
      </div>
    </Card>
