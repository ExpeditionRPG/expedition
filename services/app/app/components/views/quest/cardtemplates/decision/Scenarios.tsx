...
const scenarios: ScenarioType[] = [
  ...
  simpleScenario(
    ...
    'You climb with ease!',
    ['The adventurer that succeeded the check gains +3 damage to their next attack.'],
  ...
  simpleScenario(
    ...
    'You never were good at that manouver, though. Best let someone else try it. You call out the plan to an ally.'),
  {
    persona: 'Dark',
    skill: 'Athletics',
  ...
  simpleScenario(
    ...
    ['All adventurers that rolled for the check take +1 damage from any damage they take this round'],
