  ...
  public render() {
    ...
    return (
      <Dialog open={Boolean(this.props.open)}>
        <DialogTitle className="dialogTitle dialogError">
          {errors.length > 1 ? 'Errors Occurred' : 'Error Occurred'}
        </DialogTitle>
        <DialogContent>
          <ul>{errors}</ul>
        </DialogContent>
...
export class AnnotationDetailDialog extends React.Component<
...
> {
  public render() {
    ...
    const missingAnnotations: string = this.props.annotations
      .filter((v: number | ErrorType) => {
        return typeof v === 'number';
      })
      .join(', ');

    const renderedAnnotations: JSX.Element[] = this.props.annotations
      .filter((v: number | ErrorType) => {
        return typeof v !== 'number';
      })
      .map((a: ErrorType, i: number) => {
        const goodExampleJSX: JSX.Element[] = a.VALID.map(
          (v: string, j: number) => {
            return (
              <pre className="example" key={j}>
                {v}
              </pre>
            );
          },
        ...
        const badExampleJSX: JSX.Element[] = a.INVALID.map(
          (v: string, j: number) => {
            return (
              <pre className="example" key={j}>
                {v}
    ...
    return (
      <Dialog className="messageDetailsDialog" open={Boolean(this.props.open)}>
            ...
            <div className="annotation_details">
              ...
              {missingAnnotations && (
                <div className="reminder">
                  Couldn't find info for ID(s): {missingAnnotations}.
                </div>
              )}
              <div className="reminder">
                Remember: You can ask for help at any time using the "Contact
                us" button at the bottom right of the page.
              </div>
            </div>
          </DialogContentText>
        </DialogContent>
...
export class PublishingDialog extends React.Component<
...
> {
  ...
  public render(): JSX.Element {
    ...
    const rating =
      CONTENT_RATING_DESC[metadata.get('contentrating') as ContentRating];
    const ratings = Object.keys(CONTENT_RATING_DESC).map(
    ...
    const ratingDefinitions =
      rating &&
      Object.keys(rating.details).map((category: string, index: number) => {
        return (
          <li key={index}>
            {(rating.details as { [key: string]: string })[category]}
          </li>
        );
      });
    ...
    return (
      ...
      >
        <DialogTitle className="dialogTitle dialogGood">
          Publish your quest
        </DialogTitle>
        <DialogContent className="publishFormControl">
          <TextField
            ...
            onChange={(e: any) => {
              handleMetadataChange(quest, { summary: e.target.value });
            }}
          />
          <TextField
            className="halfWidth"
            ...
            label="Author name"
            onChange={(e: any) => {
              handleMetadataChange(quest, { author: e.target.value });
            }}
          />
          <TextField
            className="halfWidth"
            ...
            onChange={(e: any) => {
              handleMetadataChange(quest, { email: e.target.value });
            }}
          />
          <FormControl className="halfWidth">
            ...
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { minplayers: e.target.value });
              }}
            >
              {playerItems}
            </Select>
          ...
          <FormControl className="halfWidth">
            ...
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { maxplayers: e.target.value });
              }}
            >
              {playerItems}
            </Select>
          ...
          <FormControl className="halfWidth">
            <InputLabel htmlFor="mintimeminutes-select">
              Minimum play time
            </InputLabel>
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { mintimeminutes: e.target.value });
              }}
            >
          ...
          <FormControl className="halfWidth">
            <InputLabel htmlFor="maxtimeminutes-select">
              Maximum play time
            </InputLabel>
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { maxtimeminutes: e.target.value });
              }}
            >
              <MenuItem value={10}>10 minutes</MenuItem>
              <MenuItem value={20}>20 minutes</MenuItem>
          ...
          <FormControl className="halfWidth">
            ...
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { language: e.target.value });
              }}
            >
              {languages}
            </Select>
          ...
          <FormControl className="halfWidth">
            ...
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { genre: e.target.value });
              }}
            >
              {genres}
            </Select>
          ...
          <FormControl className="halfWidth">
            ...
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { theme: e.target.value });
              }}
            >
              {themes}
            </Select>
          ...
          <FormControl className="contentRatingInputContainer fullWidth">
            <InputLabel htmlFor="contentrating-select">
              Content rating
            </InputLabel>
            <Select
              ...
              onChange={(e: any) => {
                handleMetadataChange(quest, { contentrating: e.target.value });
              }}
            >
              {ratings}
            </Select>
            {metadata.get('contentrating') !== null && (
              <ul className="ratingDefinition">{ratingDefinitions}</ul>
            )}
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                handleMetadataChange(quest, { expansionhorror: checked });
              }}
            ></Checkbox>
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                handleMetadataChange(quest, { expansionfuture: checked });
              }}
            ></Checkbox>
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                handleMetadataChange(quest, { expansionwyrmsgiants: checked });
              }}
            ></Checkbox>
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                handleMetadataChange(quest, { expansionscarredlands: checked });
              }}
            ></Checkbox>
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                handleMetadataChange(quest, { requirespenpaper: checked });
              }}
            ></Checkbox>
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                this.setState({ majorRelease: checked });
              }}
            ></Checkbox>
          </FormControl>
          <FormControl className="fullWidth">
            <Checkbox
              ...
              onChange={(checked: boolean) => {
                this.setState({ privatePublish: checked });
              }}
            ></Checkbox>
            {this.state.privatePublish && (
              <div>
                Your private quest will be visible only to you in the Expedition
                App (in Quests, when "Also show my private quests" is checked in
                the search options).
              </div>
            )}
          </FormControl>
