...
const mapStateToProps = (state: AppState): StateProps => {
  return {
    ...
    feedback:
      state.view.selected.feedback !== null
        ? state.view.feedback[state.view.selected.feedback]
        : null,
    quest:
      state.view.selected.quest !== null
        ? state.view.quests[state.view.selected.quest]
        : null,
    user:
      state.view.selected.user !== null
        ? state.view.users[state.view.selected.user]
        : null,
  };
};
