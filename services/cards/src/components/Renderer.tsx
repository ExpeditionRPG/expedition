            ...
            <div className="printInstructions">
              ...
              <div className="halfWidth">
                ...
                <ol>
                  ...
                  <li>Make sure to print double-sided, and to set to document to 100% zoom. (update: there seems to be a bug in Chrome that may require setting zoom to 150% - double check the cards below before printing!)</li>
