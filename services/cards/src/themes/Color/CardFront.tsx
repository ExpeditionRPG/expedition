  ...
  public render() {
    ...
    switch (card.sheet) {
      case '-Title':
        return (
          <div
            className={`card front vertical ${card.sheet} title-${card.image}`}
          >
            ...
            <div className="contents">
              <header>
                ...
                <div className="classicon">
                  <div className="icon">
                    {icon((card.class || '').toLowerCase() + '_small')}
                  </div>
                </div>
              </header>
              <article>
      ...
      case 'Encounter':
        return (
          <div
            className={`card front dark horizontal ${card.sheet} ${card.class} tier${card.tier} ${card.health > 10 && 'bottomBar'} ${card.health === 10 && 'hp10'}`}
          >
            <div className="contents">
              <header>
              ...
              {card.image && (
                <div className={['art', card.svgClass].join(' ')}>
                  {icon(card.image)}
                </div>
              )}
              <footer>
