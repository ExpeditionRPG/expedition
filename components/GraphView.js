...
/*
var Block = function(type, title, meta, children) {
  this.type = type;
  this.title = title;
  this.meta = meta;
...
var RP = function(title, meta, children) {
  return new Block("roleplay", title, meta, children);
}

var C = function(title, meta, children) {
  return new Block("choice", title, meta, children);
}

var testTree = RP('herp', null, [
  C('choice 1', null, []),
  C('choice 2', null, [])
]);
*/
  ...
  render() {
    return (
      <div className="graphcontainer">
        <ReactNodeGraph data={exampleGraph}
