...
describe('Feedback Schema', () => {
  ...
  test('is invalid when missing partition, questid, or userid', () => {
    expect(
      Feedback.create({ ...base, userid: undefined }) instanceof Error,
    ).toEqual(true);
    expect(
      Feedback.create({ ...base, questid: undefined }) instanceof Error,
    ).toEqual(true);
    expect(
      Feedback.create({ ...base, partition: undefined }) instanceof Error,
    ).toEqual(true);
  });
  ...
  test('rejects invalid difficulty', () => {
    expect(
      Feedback.create({ ...base, difficulty: 'Invalid' }) instanceof Error,
    ).toEqual(true);
  });
