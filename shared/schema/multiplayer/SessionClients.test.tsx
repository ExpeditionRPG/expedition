...
describe('SessionClient Schema', () => {
  ...
  test('is invalid when missing session/client', () => {
    expect(
      SessionClient.create({ ...base, session: undefined }) instanceof Error,
    ).toEqual(true);
    expect(
      SessionClient.create({ ...base, client: undefined }) instanceof Error,
    ).toEqual(true);
  });
  test('is valid when session/client given', () => {
