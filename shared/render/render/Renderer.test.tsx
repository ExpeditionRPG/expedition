...
describe('Renderer', () => {
  ...
  describe('sanitizeStyles', () => {
    ...
    test('removes all other HTML tags, including whitelists with attributes', () => {
      const input = '<strong style="foo">1</strong><div>2</div><img/>3';
      const output = sanitizeStyles(input);
      const expected = '123';
      expect(output).toEqual(expected);
    });
    test('does not remove HTML-like text', () => {
    ...
    test('turns turns two separate HTML styles into two separate tags', () => {
    ...
    test('properly handles _ inside of [art_file_full]', () => {
